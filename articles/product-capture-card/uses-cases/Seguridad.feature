...
Escenario: Bloqueo de API por aceso no autorizado 
  ...
  Entonces Deberia ver una respuesta de error en formato JSON con un campo "code" con valor "InvalidCredentials"
         Y con un código de estado 401 (Unauthorized)